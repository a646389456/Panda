...
public class FourPass extends Activity
{
    int times = 3;
    ...
    public void answerPass(View v)
    {
        ...
        builder.setPositiveButton("下一关", new DialogInterface.OnClickListener()
        {
            public void onClick(DialogInterface dialog, int which)
            {
                Intent intent  = new Intent(FourPass.this, FivePass.class);
    ...
    public void notPass(View v)
    {
        ...
        Toast.makeText(FourPass.this,"未找到熊猫，还剩" + (times - 1) + "次机会", Toast.LENGTH_SHORT).show();
    }
}
