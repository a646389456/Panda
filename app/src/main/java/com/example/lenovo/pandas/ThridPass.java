...
public class ThridPass extends Activity
{
    int times = 3;
    ...
    public void notPass(View v)
    {
        ...
        Toast.makeText(ThridPass.this,"未找到熊猫，还剩" + (times - 1) + "次机会", Toast.LENGTH_SHORT).show();
    }
}
